export default function Register() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/11645/306219a7-90fd-430f-9529-e6997309a093')",
      }}
    >
        ...
        <div className="flex-2 flex flex-col items-center justify-center">
          <form className="grid w-full grid-cols-1 md:grid-cols-2 justify-center md:px-5 gap-5 md:py-10 p-2 border-b-2">
            ...
            <div className="flex w-full">
              <button className="bg-primary w-40 hover:bg-green-500/80 hover:scale-95 duration-300 transition-all rounded-md px-5 py-3 text-white font-bold">
                Register
              </button>
            </div>
          </form>
          <div className="flex flex-col ">
            <h1 className=" w-full p-2 text-white font-bold outline-none py-3 px-3 rounded-lg ">
